...
CUDA_VISIBLE_DEVICES=5 python  -m torch.distributed.launch --nproc_per_node=1  --master_port=10455  \
	train.py ${VTAB_PATH}/dmlab  --dataset dmlab --num-classes 6  --no-aug  --direct-resize  --model vit_small_patch16_224_in21k  \
	...
	--output  ${OUTPUT_PATH}/vit_small_patch16_224_in21k/vtab/dmlab/ssf \
