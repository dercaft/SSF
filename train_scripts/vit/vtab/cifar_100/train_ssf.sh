...
CUDA_VISIBLE_DEVICES=1 python  -m torch.distributed.launch --nproc_per_node=1  --master_port=10451  \
	train.py ${VTAB_PATH}/cifar/  --dataset cifar100 --num-classes 100  --no-aug --direct-resize --model vit_small_patch16_224_in21k  \
	...
	--output  ${OUTPUT_PATH}/vit_small_patch16_224_in21k/vtab/cifar_100/ssf \
