...
CUDA_VISIBLE_DEVICES=$1 python  -m torch.distributed.launch --nproc_per_node=$2  --master_port=$3  \
	...
	--reg 1e-4\
	--initial-checkpoint "/data/wyh/SSF/vit_base_patch16_224_in21k/cifar_100/pruning_retrain/20230720-095813-vit_base_patch16_224_in21k-224/checkpoint-88.pth.tar" \
	--evaluate \
    --no-save \
